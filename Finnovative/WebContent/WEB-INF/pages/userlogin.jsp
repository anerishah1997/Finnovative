...
<body>
	<div class="full-height" id="grad1">
		...
		<div class="navbar">
			<a href="indexPage"> Home</a> <a href="userlogin.jsp">Login</a>
		...
		<form action="userlogin.do" method="post">
			<table align="center">
				<tr>
					...
					<td><input type="text" name="userLogin" id="userName"
				...
				<tr>
					...
					<td><input type="password" name="userPassword"
						id="userPassword" placeholder="Enter password"></td>
				</tr>
				<tr colspan="2">
					<td></td>
					<td style="text-align: right; color: red; font-style: italic"
				...
				<tr>
					<td colspan="2" align="center"><input type="submit"
						value="Login" class="button" onclick="validate()" /></td>
				</tr>
				</tr>
				<tr>
