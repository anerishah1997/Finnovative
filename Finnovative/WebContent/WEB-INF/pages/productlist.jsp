...
<body>
	<div class="full-height" id="grad1">
		...
		<div class="navbar">
			<a href="indexPage">Home</a> <a href="viewDashboardPage">Dashboard</a>
		...
		<c:choose>
			...
			<c:when test="${sessionScope.user != null }">
				...
				<br>
				<form action="buyProduct.do" method="GET"
					...
					<div class="row">
						...
						<c:forEach var="prod" items="${ requestScope.productList }">
							...
							<div align="center">
								...
								<div class="column">
									<div class="card">
										<img src="images/${ prod.productImage }" alt="OnePlus3"
											style="width: 100%">
										...
										<p>
											Rs.
											<c:out value="${ prod.productPrice }" />
										</p>
										<button type="submit" name="productId" value=${prod.productId} >BUY
											NOW</button>
