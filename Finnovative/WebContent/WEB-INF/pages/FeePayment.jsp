	...
	<div class="full-height" id="grad1">
		...
		<div class="navbar">
			<a href="index.jsp"><i class="fa fa-fw fa-home"></i> Home</a> <a
				style="float: right" href="adminlogin.html">Logout</a> <a
				style="float: right" href="adminlogin.html">About Us</a> <a
				style="float: right" href="index.html">FAQs</a>
		</div>
		</header>
		<form action="activateUser.do" method="post">
			<table align="center"
				style="margin-left: auto; margin-right: auto; margin-top: 4%; margin-bottom: 0%">
				<tr>
					<th>Fees Payment</th>
				</tr>
				<tr>
					...
					<td><input type="text"
						value='<c:out value="Rs. ${requestScope.fee}"></c:out>' readonly>
					</td>
				</tr>
				<tr>
